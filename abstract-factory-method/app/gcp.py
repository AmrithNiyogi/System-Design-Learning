...
class GCSSignedUrlGenerator(SignedUrlGenerator):

    def generate_upload_url(self, upload_request: dict) -> str:
        filename = upload_request["filename"]
        return f"https://storage.googleapis.com/docs/{filename}?upload=1"

    def generate_download_url(self, document_id: str) -> str:
        return f"https://storage.googleapis.com/docs/{document_id}?download=1"
